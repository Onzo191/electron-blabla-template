...
> Vendored from https://github.com/trailofbits/skills (CC-BY-SA-4.0, see ../TRAILOFBITS-LICENSE). Manual-only: invoke with /sharp-edges. Re-sync quarterly per docs/claude-code-skills.md.
